...
?>
    ...
    <!-- <section class='hero'>
        ...
        <a href='#latest' id='recent' class='recent-post'>The Latest Thought<i class='fa fa-chevron-down'></i></a>
    ...
    <article>
        ...
        <section class='content'>
            <div class='container'>
                ...
                <h6 class='date'>&copy; Copyright Josh Beveridge – <?php echo date('Y'); ?></h5>
            </div>
        </section>
    </article>
